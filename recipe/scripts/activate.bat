...
dir "%CONDA_PREFIX%\Library\bin\python.exe" >nul 2>&1 || (
    echo "python.exe not found in %CONDA_PREFIX%\Library\bin\python.exe"
    exit /b 1
)

set "PGADMIN4_PY_EXEC=%CONDA_PREFIX%\Library\bin\python.exe"
